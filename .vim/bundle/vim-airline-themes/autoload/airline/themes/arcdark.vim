...
let g:airline#themes#arcdark#palette.normal_modified = {
...
let g:airline#themes#arcdark#palette.insert = airline#themes#generate_color_map(s:I1, s:N2, s:I3)
let g:airline#themes#arcdark#palette.insert_modified = copy(g:airline#themes#arcdark#palette.normal_modified)
let g:airline#themes#arcdark#palette.insert_paste = {
      \ 'airline_a': [s:gui_dark_gray, s:gui_orange, s:cterm_dark_gray, s:cterm_orange, ''],
      \ }

" Replace mode
let g:airline#themes#arcdark#palette.replace = {
      ...
      \ }
let g:airline#themes#arcdark#palette.replace_modified = copy(g:airline#themes#arcdark#palette.insert_modified)
...
let g:airline#themes#arcdark#palette.visual = airline#themes#generate_color_map(s:V1, s:N2, s:V3)
let g:airline#themes#arcdark#palette.visual_modified = copy(g:airline#themes#arcdark#palette.insert_modified)
...
let g:airline#themes#arcdark#palette.inactive_modified = {
...
let g:airline#themes#arcdark#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
