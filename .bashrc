...
PS1='\[\007\e[0;32m\][\u \[\e[1;34m\]\w\[\e[0;32m\]$(parse_git_branch) ] \[\e[1;32m\]\$ \[\e[0m\]'
PROMPT_COMMAND='es=$?; [[ $es -eq 0 ]] && unset error || error=$(echo -e " $es ")'
PS1="\[\e[1;41m\]\$error\[\e[0m\]${PS1}"
export PATH=$PATH:/home/peter/Scripts
#export PATH=$PATH:/home/peter/Projects/Nim/bin
export PATH=$PATH:/home/peter/HDD_storage/AndroidSDK/android-sdk-linux/tools
export PATH=$PATH:/home/peter/.gem/rbx/2.2/gems/apricot-0.0.2/bin
export PATH=$PATH:/home/peter/.nimble/bin
export PATH=$PATH:/home/peter/HDD_storage/AndroidSDK/android-ndk-r12
